...
#include "listeners_v2.hpp"

class MyDataWriterListener
        : public dds::pub::NoOpDataWriterListener<listeners_v2> {
public:
    virtual void on_offered_deadline_missed(
            dds::pub::DataWriter<listeners_v2> &writer,
        ...
        unsigned int sample_count)
{
    ...
    dds::topic::Topic<msg2> inconsistent_topic(participant, "topic_listeners");
    ...
    dds::pub::DataWriter<msg2> inconsistent_writer(
            publisher,
            inconsistent_topic);
    ...
    dds::topic::Topic<listeners_v2> topic(participant, "topic_listeners");
    ...
    dds::pub::DataWriter<listeners_v2> writer(publisher, topic);
    writer.set_listener(dw_listener);

    // Create data sample for writing
    listeners_v2 instance;

    // Main loop
    for (unsigned int samples_written = 0;
         !application::shutdown_requested && samples_written < sample_count;
         samples_written++) {
        std::cout << "Writing listeners_v2, count " << samples_written
                  << std::endl;
