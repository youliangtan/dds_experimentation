...
public:
            ...
            const dds::core::status::InconsistentTopicStatus &status)
    {
        std::cout << "ParticipantListener: on_inconsistent_topic()!!!"
                  << std::endl;
        std::cout << " msg def::" << topic.name() << " " << topic.type_name()
                  << "\n" << std::endl;
    }
};
...
class MyDataReaderListener
        : public dds::sub::NoOpDataReaderListener<listeners_v2> {
    virtual void on_requested_deadline_missed(
            dds::sub::DataReader<listeners_v2> &reader,
            const dds::core::status::RequestedDeadlineMissedStatus &status)
    {
    ...
    virtual void on_data_available(dds::sub::DataReader<listeners_v2> &reader)
    {
        dds::sub::LoanedSamples<listeners_v2> samples = reader.take();
        ...
        unsigned int sample_count)
{
    ...
    dds::sub::DataReader<listeners_v2> reader(subscriber, topic);
