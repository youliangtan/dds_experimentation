...
#define MSG_VERSION 2 /// Toggle this
#include <algorithm>
#include <iostream>
...
#if MSG_VERSION == 1
    #include "HelloWorld_v1.hpp"
    using HelloWorld_VX = HelloWorld_v1;
#elif MSG_VERSION == 2
    #include "HelloWorld_v2.hpp"
...
unsigned int process_data(dds::sub::DataReader<HelloWorld_VX>& reader)
{
    // Take all samples.  Samples are loaned to application, loan is
    // returned when LoanedSamples destructor called.
    unsigned int samples_read = 0;
    dds::sub::LoanedSamples<HelloWorld_VX> samples = reader.take();
...
void run_example(unsigned int domain_id, unsigned int sample_count)
{
    ...
    dds::topic::Topic<HelloWorld_VX> topic(participant, "hello_world_topic");
    ...
    dds::sub::DataReader<HelloWorld_VX> reader(subscriber, topic);
